 ...
 * @author James Celona
 */
public class DeprecatedTask implements Parcelable {
	 ...
	 */
	public static DeprecatedTask taskFromString(String string) {
		String[] tokens = string.split(DIV);
		DeprecatedTask deprecatedTask = new DeprecatedTask();
		
		deprecatedTask.name = tokens[NAME];
		deprecatedTask.is_completed = Boolean.parseBoolean(tokens[IS_COMPLETED]);
		deprecatedTask.priority = Integer.parseInt(tokens[PRIORITY]);
		deprecatedTask.date_created = calendarFromString(tokens[DATE_CREATED]);
		deprecatedTask.date_due = calendarFromString(tokens[DATE_DUE]);
		deprecatedTask.notes = notesFromString(tokens[NOTES]);
	 ...
	 */
	public DeprecatedTask() {}
	
	/**
	 * Copy constructor.
	 * @param deprecatedTask the Task to be copied
	 */
	public DeprecatedTask(DeprecatedTask deprecatedTask) {
		name = deprecatedTask.name;
		is_completed = deprecatedTask.is_completed;
		priority = deprecatedTask.priority;
		date_created = deprecatedTask.date_created;
		date_due = deprecatedTask.date_due;
		notes = deprecatedTask.notes;
	}
	...
	public static final Parcelable.Creator<DeprecatedTask> CREATOR = new Parcelable.Creator<DeprecatedTask>() {
		public DeprecatedTask createFromParcel(Parcel in) {
			return new DeprecatedTask(in);
		}
		
		public DeprecatedTask[] newArray(int size) {
			return new DeprecatedTask[size];
		}
	};
	
	private DeprecatedTask(Parcel in) {
		name = in.readString();
	...
	public DeprecatedTask setName(String task_name) {
		this.name = task_name;
		return this;
	}
	
	public DeprecatedTask setIsCompleted(boolean is_completed) {
		this.is_completed = is_completed;
		return this;
	}
	
	public DeprecatedTask toggleIsCompleted() {
		is_completed = is_completed ? false : true;
		return this;
	}
	
	public DeprecatedTask setPriority(int priority) {
		if (priority >= TRIVIAL && priority <= URGENT)
			this.priority = priority;
		return this;
	}
	
	public DeprecatedTask setCreationDate(Calendar date_created)
	{
		this.date_created = date_created;
		return this;
	}
	
	public DeprecatedTask setDueDate(Calendar date_due)
	{
		this.date_due = date_due;
		return this;
	}

	public DeprecatedTask setNotes(String notes) {
		this.notes = notes;
		return this;
	}
}
