/*
 * TaskFinalDateDueComparator.java
 * 
...
/**
 * Comparator for sorting tasks by final due date.
 * @author Jonathan Hasenzahl
 */
public class TaskFinalDateDueComparator implements Comparator<Task> {
	...
	public int compare(Task lhs, Task rhs) {
		if (lhs.getFinalDateDue() == 0) {
			// Case 1: lhs has no due date
			if (rhs.getFinalDateDue() > 0) {
