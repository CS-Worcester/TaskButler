 ...
 */
public class DeprecatedTaskListAdapter extends ArrayAdapter<DeprecatedTask> {
	 ...
	 */
	public DeprecatedTaskListAdapter(Activity activity, ArrayList<DeprecatedTask> deprecatedTasks) {
