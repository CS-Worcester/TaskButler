...
class AsyncLoadTasks extends AsyncTask<Void, Void, List<String>> {
	...
	protected void onPostExecute(List<String> result) {
		...
		Category c = new Category(tds.getNextID(DatabaseHandler.TABLE_CATEGORIES),
				"My Google TasksList", Color.parseColor("#47A802"), System.currentTimeMillis());
		tds.addCategory(c);
