...
import edu.worcester.cs499summer2012.adapter.DeprecatedTaskListAdapter;
 ...
 * @author James Celona
 */
public class DeprecatedMainActivity extends SherlockListActivity implements OnItemLongClickListener, 
		ActionMode.Callback {
    ...
    private DeprecatedTaskListAdapter adapter;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter = new DeprecatedTaskListAdapter(this, new ArrayList<DeprecatedTask>(0));
